...
class TwoFragmentAdapter(val context : Context,val twoFragment: TwoFragment, val musicList: MutableList<MusicData>) :
    RecyclerView.Adapter<TwoFragmentAdapter.CustomViewHolder>() {
